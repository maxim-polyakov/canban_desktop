...
public interface IQuestService
{
    ...
    Task<QuestDto?> UpdateAsync(Guid id, UpdateQuestRequest request, Guid userId, CancellationToken ct = default);
    ...
    Task<ArchiveCompletedQuestsResult?> ArchiveCompletedAsync(Guid boardId, Guid userId, CancellationToken ct = default);
