...
public record SkillDto(Guid Id, string Key, string Name, string? Description, string? IconUrl, Guid? ParentSkillId, int TreeOrder, int PositionX, int PositionY, bool Unlocked);
